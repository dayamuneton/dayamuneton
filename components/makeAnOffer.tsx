...
function MakeAnOffer({ initialPrice }: { initialPrice: number }) {
   ...
   return (
      <div className="text-lg bg-[#4a23a9] text-white border-2 border-[#4a23a9] rounded-md ">
         <button
         ...
         <form
            onSubmit={sendEmail}
            className={`overflow-hidden w-full flex flex-col items-center transition-all duration-300 ease-in-out px-4 ${
               isOpen ? "max-h-[1000vh]" : "max-h-[0vh]"
            }`}
         >
